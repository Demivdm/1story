...
import { toValue, ref as ref2, shallowRef, getCurrentScope, isRef, watch, onScopeDispose, getCurrentInstance as getCurrentInstance2, onServerPrefetch, isVue3, toRef, effectScope as effectScope2, inject as inject2, computed as computed2 } from "vue-demi";
...
function useFirebaseAuth(name) {
  ...
  return isClient ? inject2(_VueFireAuthKey) : null;
}
